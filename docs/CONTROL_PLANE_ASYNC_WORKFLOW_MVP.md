...
- **Commands (CMD\_\*)** are synchronous requests handled via the CMD Service and Orchestrator.
- **Events (EVT\_\*)** are asynchronous facts published by the module that performed the action.
...
2. **Completion (asynchronous)**
   ...
   - Delivered as EVT\_\*\_RESULT events
...
- Subscribe to EVT\_\*\_RESULT events
